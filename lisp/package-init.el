...
(use-package rom-party
  ...
  :config
  (setq rom-party-chosen-words '("rne" "garner" "tco" "outcome" "hra" "thrash" "oic" "voice" "isu" "visual" "rbu" "overburden" "mv" "triumvirate" "uiv" "quiver" "rpa" "vorpal" "rdr" "wizardry" "umf" "humf" "ak" "yak" "elc" "belch" "llh" "hellhole" "gho" "ghost" "ehy" "dehydrate" "rtn" "partner" "olc" "volcano" "oei" "onomatopoeia" "amu" "gamut" "shm" "shmuck" "wc" "showcase" "ewo" "rework" "efu" "useful" "myo" "myopic" "ldo" "seldom" "vem" "movement" "rw" "narwhal" "df" "dreadful" "eun" "eunuch" "yne" "slyness" "efr" "refresh" "ptr" "sceptre" "apl" "maple" "hh" "shh" "skr" "skry" "bp" "subpar" "sg" "misgive" "ioc" "idiocy" "iy" "hiya" "ysa" "naysayer" "uld" "would" "inh" "sinh" "eor" "meteor" "aln" "walnut" "ssw" "password" "seu" "museum" "reu" "reuse" "gmo" "sigmoid" "iec" "piece" "kp" "jackpot" "rtr" "portray" "shn" "shnap" "ml" "dimly" "omy" "roomy" "lva" "elvan" "ily" "wily" "bte" "subtext" "kc" "blackcap" "asu" "erasure" "bsi" "subsidy" "yco" "tycoon" "lbu" "album" "rtl" "turtle" "ybr" "hybrid" "aig" "taiga" "mt" "dreamt" "rnu" "butternut" "ynt" "sythetic" "lta" "delta" "cka" "jackal" "opo" "isopod" "anf" "fanfare" "rfa" "warfare" "icu" "ridicule" "pio" "pioneer" "cco" "accomodate" "ngb" "longbow" "bry" "embryo" "eci" "recipe")))
